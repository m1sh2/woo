...
JCommentsForm.prototype = {
	...
	init: function(id,editor){
	 // console.info('InitForm');
	  this.id=id;this.form=this.$(id);this.editor=editor;this.events=new JCommentsEvents();this.setElements(new Array('name','email','homepage','title','comment'));this.restoreValues();this.clear('captcha');this.setCaptcha();},
...
JComments.prototype = {
	...
	showPage: function(i,g,p){
	  ...
	  this.busyList();
	  //console.info(this.ajax('JCommentsShowPage',arguments));
